            ...
            <td style="padding:28px 32px;">
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0;font-size:15px;color:#c0392b;font-weight:700;">
                      Al cierre del día se detectaron {{ count($alertas) }} producto{{ count($alertas) > 1 ? 's' : '' }} en o por debajo de su stock mínimo configurado.
                    </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:24px;">
                ...
                <tbody>
                  ...
                  <tr style="background:{{ $loop->even ? '#fff5f5' : '#ffffff' }};border-bottom:1px solid #f0d0ce;">
                    ...
                    <td style="padding:10px 12px;text-align:center;font-size:13px;color:#888;">
                      {{ number_format($alerta['stock_minimo'], 2, ',', '.') }}
                    </td>
                  </tr>
                  @endforeach
                </tbody>
          ...
          <tr>
            <td style="background:#f8f9fa;padding:16px 32px;text-align:center;border-top:1px solid #e9ecef;">
              <p style="margin:0;font-size:12px;color:#aaa;">
                <strong style="color:#c0392b;">PVenta</strong> — Sistema de Punto de Venta &nbsp;|&nbsp; {{ $fechaReporte }}
              </p>
            </td>
          </tr>

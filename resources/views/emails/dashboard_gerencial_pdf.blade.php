  ...
  <div class="wrap">
    ...
    <div class="body">
      ...
      <p>
        ...
        <strong>{{ $empresaNombre }}</strong>, generado el
        {{ \Carbon\Carbon::now()->isoFormat('dddd D [de] MMMM [de] YYYY, HH:mm') }}.
      </p>
    ...
    <div class="footer">
      &copy; {{ date('Y') }} Sistema PVenta &nbsp;·&nbsp; Generado el {{ now()->format('d/m/Y H:i') }}
    </div>
  </div>
</body>
</html>

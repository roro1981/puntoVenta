...
<head>
    <meta charset="utf-8">
    <title>Tickets Preparacion - {{ $comanda->numero_comanda ?? ('#' . $comanda->id) }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    @php
        $bloques = [
            ['titulo' => 'COCINA', 'detalles' => $detallesCocina],
            ['titulo' => 'BARRA', 'detalles' => $detallesBarra],
        ];
    @endphp
    ...
    @foreach($bloques as $bloque)
        ...
        <div class="ticket-page">
            <div class="title-box">*** {{ $bloque['titulo'] }} ***</div>
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    <span class="info-label">GARZON:</span>
            ...
            @forelse($bloque['detalles'] as $detalle)
                @php
            ...
            <div class="total-items">
                Total items: {{ collect($bloque['detalles'])->sum('cantidad') }}
            </div>

...
class SubmenusTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('submenus')->insert([
            ...
            ['menu_id' => 4, 'submenu_name' => 'Ventas por vendedor',      'submenu_route' => '/vtas_vendedor',    'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 4, 'submenu_name' => 'Ventas por garzón',        'submenu_route' => '/vtas_garzon',      'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 4, 'submenu_name' => 'Ventas por mesa',          'submenu_route' => '/vtas_mesa',        'created_at' => Carbon::now()->toDateTimeString()],
            // -- Productos --
            ...
            ['menu_id' => 5, 'submenu_name' => 'Permisos-menu', 'submenu_route' => '/permisos', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 5, 'submenu_name' => 'Permisos-roles', 'submenu_route' => '/permisos-roles', 'created_at' => Carbon::now()->toDateTimeString()],

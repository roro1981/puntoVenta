...
class SubmenusTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('submenus')->insert([
            ...
            ['menu_id' => 1, 'submenu_name' => 'Modificar recetas', 'submenu_route' => '/mod_recetas', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 1, 'submenu_name' => 'Eliminar recetas', 'submenu_route' => '/elim_recetas', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 1, 'submenu_name' => 'Promociones', 'submenu_route' => '/promociones', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 1, 'submenu_name' => 'Modificar promociones', 'submenu_route' => '/mod_promociones', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 1, 'submenu_name' => 'Eliminar promociones', 'submenu_route' => '/elim_promociones', 'created_at' => Carbon::now()->toDateTimeString()],
            ...
            ['menu_id' => 2, 'submenu_name' => 'Ingresos', 'submenu_route' => '/ingresos', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 2, 'submenu_name' => 'Proveedores', 'submenu_route' => '/proveedores', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 3, 'submenu_name' => 'Ventas', 'submenu_route' => '/ventas', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 3, 'submenu_name' => 'Tickets emitidos', 'submenu_route' => '/tickets_emitidos', 'created_at' => Carbon::now()->toDateTimeString()],
            ['menu_id' => 3, 'submenu_name' => 'Clientes', 'submenu_route' => '/clientes', 'created_at' => Carbon::now()->toDateTimeString()],
            ...
            ['menu_id' => 5, 'submenu_name' => 'Permisos y roles', 'submenu_route' => '/permisos_roles', 'created_at' => Carbon::now()->toDateTimeString()],

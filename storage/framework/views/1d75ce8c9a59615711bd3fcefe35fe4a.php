        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" max="100" step="0.01" id="cerrar_propina_porcentaje" class="form-control" value="<?php echo e(rtrim(rtrim(number_format($porcentajePropina ?? 10, 2, '.', ''), '0'), '.')); ?>">
                </div>
...
<script>
    window.cajaAbierta = <?php echo json_encode($cajaAbierta, 15, 512) ?>;
    window.porcentajePropinaGlobal = <?php echo json_encode((float)($porcentajePropina ?? 10), 15, 512) ?>;
</script>
<?php /**PATH C:\xampp\htdocs\pventa-app\resources\views/ventas/cerrar_comandas.blade.php ENDPATH**/ ?>
                    ...
                    <td style="background:#0f766e;padding:22px 26px;color:#ffffff;">
                        ...
                        <p style="margin:4px 0 0 0;font-size:12px;opacity:.85;">
                            Inicio: <?php echo e($data['fecha_apertura']->format('d/m/Y H:i:s')); ?> | Cierre: <?php echo e($data['fecha_cierre']->format('d/m/Y H:i:s')); ?> | Duración: <?php echo e($data['duracion']); ?>
                                                 ...
                                                 <p style="margin:8px 0 0 0;font-size:12px;color:#fbbf24;background-color:rgba(251,191,36,0.1);padding:8px;border-radius:4px;">
                                                     <strong>Observaciones:</strong> <?php echo e(nl2br(e($data['observaciones']))); ?>
                            ...
                            <tr>
                                <td width="50%" style="padding:6px;vertical-align:top;">
                                    <div style="border:1px solid #e5e7eb;border-radius:8px;padding:12px;">
                                        ...
                                        <div style="font-size:28px;font-weight:700;">$<?php echo e(number_format($data['total_ventas'], 0, ',', '.')); ?></div>

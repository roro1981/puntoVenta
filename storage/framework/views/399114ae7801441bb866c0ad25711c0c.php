...
<body>
    ...
    <div class="subtitle">
        <?php echo e($cajas->first()->fecha_apertura->format('d/m/Y H:i')); ?> — <?php echo e($cajas->last()->fecha_cierre->format('d/m/Y H:i')); ?>
    ...
    <table class="cajas-table">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e(sprintf('%04d', $caja->id)); ?></td>
                <td><?php echo e(Str::limit($caja->usuario->name ?? 'N/A', 10)); ?></td>
                <td>$<?php echo e(number_format($caja->monto_ventas, 0, ',', '.')); ?></td>
            </tr>
    ...
    <div class="info-row">
        ...
        <span><?php echo e($cajas->count()); ?></span>
    </div>
    <div class="info-row">
        <span>CANTIDAD DE VENTAS:</span>
        <span><?php echo e($cantidadVentas); ?></span>
    </div>
    <div class="info-row">
    ...
    <table style="width:100%;font-size:9px;border-collapse:collapse;margin:2px 0;">
        ...
        <tfoot>
            <tr style="border-top:1px solid #000;">
                ...
                <td style="text-align:right;padding:2px 0;"><strong>-$<?php echo e(number_format($totalRetiros, 0, ',', '.')); ?></strong></td>
            </tr>
        </tfoot>
    </table>
    ...
    <div class="totals-section">
        <div class="total-row">
            ...
            <span>$<?php echo e(number_format($montoInicialTotal, 0, ',', '.')); ?></span>
        </div>
        ...
        <div class="total-esperado">
            <div class="total-row">
                ...
                <span>$<?php echo e(number_format($montoInicialTotal + $totalVentas - ($totalRetiros ?? 0), 0, ',', '.')); ?></span>
            </div>
        </div>
        ...
        <div class="total-declarado">
            <div class="total-row">
                ...
                <span>$<?php echo e(number_format($montoDeclaradoTotal, 0, ',', '.')); ?></span>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\pventa-app\resources\views/ventas/ticket_consolidado.blade.php ENDPATH**/ ?>
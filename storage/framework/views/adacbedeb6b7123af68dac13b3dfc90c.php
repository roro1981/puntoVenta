<link rel="stylesheet" href="css/users/principal.css" />
<script type="text/javascript" src="js/users/principal.js"></script>
<div class='row'>
  <div class='col-xs-12'>
      <div style="width:100%">
        <div class='box-header' style="width:100%">
            <button class="btn btn-dropbox" data-toggle="modal" id="nuevo_user" data-target="#createUserModal"><i class='fa fa fa-save'></i>Nuevo Usuario</button>
...
<?php echo $__env->make('partials.modal_ayuda', ['modulo' => 'usuarios'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        

<?php /**PATH C:\xampp\htdocs\pventa-app\resources\views/users/principal.blade.php ENDPATH**/ ?>
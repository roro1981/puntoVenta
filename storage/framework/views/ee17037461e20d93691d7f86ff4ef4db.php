            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="codigo" id="codigo" class="form-control"
                           value="<?php echo e(old('codigo', $promo->codigo)); ?>" required readonly>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control"
                           value="<?php echo e(old('nombre', $promo->nombre)); ?>" required>
                </div>
                    ...
                    <select name="categoria_id" id="categoria_id" class="form-control">
                        ...
                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option 
                                ...
                                <?php echo e((old('categoria_id', $promo->categoria_id) == $cat->id) ? 'selected' : ''); ?>
                ...
                <div class="card mt-3 mx-auto" style="max-width: 600px; border:1px solid #ccc; padding:15px; background-color: #f9f9f9;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            ...
                            <input type="date" id="fecha_inicio" class="form-control" value="<?php echo e(old('fecha_inicio', $promo->fecha_inicio)); ?>" style="font-size:14px;"
                            <?php echo e(is_null($promo->fecha_inicio) && is_null($promo->fecha_fin) ? 'disabled' : ''); ?>>
                        </div>
                        ...
                        <div class="col-md-6 d-flex align-items-center mt-2 mt-md-0">
                            ...
                            <input type="date" id="fecha_termino" class="form-control" value="<?php echo e(old('fecha_fin', $promo->fecha_fin)); ?>" style="font-size:14px;"
                            <?php echo e(is_null($promo->fecha_inicio) && is_null($promo->fecha_fin) ? 'disabled' : ''); ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-check mt-3">
                        ...
                        <?php echo e(is_null($promo->fecha_inicio) && is_null($promo->fecha_fin) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="precio_costo" id="precio_costo" class="form-control"
                           value="<?php echo e(old('precio_costo', $promo->precio_costo)); ?>" 
                           readonly>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="precio_venta" id="precio_venta" class="form-control" onkeypress="return soloNumeros(event)"
                           value="<?php echo e(old('precio_venta', $promo->precio_venta)); ?>">
                </div>
        ...
        <div class='col-md-8' >
            ...
            <div class="form-group" style="position: relative; display: inline-block;">
               ...
               <div id="listaProductos" class="suggestion-box" style="display: none;"></div>
                ...
                <input type="hidden" id="uuid_promo" value="<?php echo e($promo->uuid); ?>">
            </form>
        </div>
        <br>
            ...
            <div>
                ...
                <div class='box-body table-responsive' >
                    <table class="table table-bordered" id="tabla_detalle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $promo->detallePromocion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $det): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-codigo="<?php echo e($det->producto->codigo); ?>">
                                    <td><?php echo e($det->producto->codigo); ?></td>
                                    <td><?php echo e($det->producto->descripcion); ?></td>
                                    <td class="td-unidad"><?php echo e($det->unidad); ?></td>
                                    <td class="td-cantidad"><?php echo e($det->cantidad); ?></td>
                                    <td class="td-precio"><?php echo e($det->producto->precio_compra_neto); ?></td>
                                    <td class="td-total"><?php echo e($det->cantidad * $det->producto->precio_compra_neto); ?></td>
                                    <td>
...
<?php /**PATH C:\xampp\htdocs\pventa-app\resources\views/almacen/editar_promociones.blade.php ENDPATH**/ ?>
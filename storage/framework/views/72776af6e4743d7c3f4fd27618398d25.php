    ...
    <div class='col-xs-12'>
        <div style="width:100%">
            ...
            <div style="margin-bottom: 10px; display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                <button id="btnConsolidar" class="btn btn-warning btn-sm" disabled>
                    <i class="fa fa-compress"></i> Consolidar seleccionadas (<span id="countSeleccionadas">0</span>)
                </button>
                <button id="btnDeseleccionarTodo" class="btn btn-default btn-sm" style="display:none;">
                    <i class="fa fa-times"></i> Deseleccionar todo
                </button>
            </div>
            ...
            <table id='tabla_cierres' class="display" style="width:100%">
                <thead>
                    <tr style="background-color: #01338d;color:white">
                        <th><input type="checkbox" id="checkTodos" title="Seleccionar todos"></th>
                        <th>Nº CIERRE</th>
                        <th>USUARIO</th>
                        <th>APERTURA</th>
                        <th>CIERRE</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #e67e22; color: white;">
                <h5 class="modal-title">
                    <i class="fa fa-compress"></i> Consolidado de Cierres de Caja
                </h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-footer" id="consolidadoFooter" style="display:none;">
                <button type="button" id="btnImprimirConsolidado" class="btn btn-primary">
                    <i class="fa fa-print"></i> Imprimir Ticket
                </button>
                <button type="button" id="btnExcelConsolidado" class="btn btn-success">

...
<div class="col-md-12">
                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: auto; display: none;" id="formularioregistros">
                          ...
                          <div style="margin-top:-12px" class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option value="<?php echo e($prov->uuid); ?>"><?php echo e($prov->razon_social); ?></option>
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <?php $__currentLoopData = $impuestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php $color = $cont == 0 ? 'color:blue;font-size:13pt;' : 'color:black;font-size:10pt;'; ?>
                      
                          <span style="<?php echo e($color); ?>">
                              <?php echo e($imp->nom_imp); ?> (<?php echo e($imp->valor_imp); ?>%):
                          </span>
                          <label class="val_imp" id="<?php echo e(strtoupper($imp->nom_imp)); ?>" style="<?php echo e($color); ?>margin-right:10px;"></label>
...
<?php echo $__env->make('partials.modal_ayuda', ['modulo' => 'compras_ingresos'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pventa-app\resources\views/compras/ingresos.blade.php ENDPATH**/ ?>
...
<style>
  ...
  .cpv-search-row #btnVerPendientes {
    flex: 0 0 auto;
    height: 46px;
    border-radius: 10px;
    padding: 0 16px;
  ...
  #tablaPreventasPendientes .detalle-productos td {
    background: #f7f9fd;
    padding: 10px 14px;
  }
      ...
      <div class="cpv-card">
        ...
        <div class="cpv-card-body">
                ...
                <div class="cpv-search-row">
                        ...
                        <button class="btn btn-secondary" id="btnVerPendientes"><i class="fa fa-list"></i> Ver Pendientes</button>
                      </div>
                    </div>
...
<div class="modal fade" id="modalRetiroCaja" tabindex="-1" aria-labelledby="tituloRetiroCaja" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-warning text-dark">
        <h4 class="modal-title" id="tituloRetiroCaja">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="retiroCajaTipoCaja" value="ALMACEN">
        <div class="form-group">
...
<div class="modal fade" id="modalPreventasPendientes" tabindex="-1" aria-labelledby="tituloPreventasPendientes" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-secondary text-white">
        <h4 class="modal-title" id="tituloPreventasPendientes">
          <i class="fa fa-list"></i> Preventas Pendientes
        </h4>
      ...
      <div class="modal-body" style="padding: 0;">
        <div id="pendientesLoading" class="text-center py-4">
          <i class="fa fa-spinner fa-spin fa-2x text-secondary"></i>
          <p class="text-muted mt-2">Cargando preventas...</p>
        </div>
        <div id="pendientesEmpty" class="alert alert-info m-3" style="display:none;">
          <i class="fa fa-info-circle"></i> No hay preventas pendientes en este momento.
        </div>
        <div id="pendientesTableWrap" style="display:none;">
          <table class="table table-bordered table-hover mb-0" id="tablaPreventasPendientes">
            <thead class="thead-light">
              <tr>
                <th style="width:110px;">N° Preventa</th>
                <th>Fecha</th>

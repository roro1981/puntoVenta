...
class ProductoRequest extends FormRequest
{
    public static function buildRules(bool $isUpdate = false): array
    {
        $rules = [
            ...
            'precio_compra_neto' => ['required', 'numeric', 'min:0'],
            'impuesto_1' => ['required', 'numeric', 'min:1', 'max:99.9'],
            'impuesto_2' => ['nullable', 'numeric', 'min:0', 'max:99.9'],
            'precio_compra_bruto' => ['required', 'numeric', 'min:0.1'],
            ...
            'sector_impresion' => ['nullable', 'in:B,C'],
    ...
    public static function buildMessages(): array
    {
        return [
            ...
            'precio_compra_neto.numeric' => 'El precio de compra neto debe ser un número.',
            ...
            'impuesto_2.min' => 'El impuesto 2 debe ser al menos 0.',
            'impuesto_2.max' => 'El impuesto 2 no puede superar 99.9.',
            'precio_compra_bruto.required' => 'El precio de compra bruto es obligatorio.',
            'precio_compra_bruto.numeric' => 'El precio de compra bruto debe ser un número.',
            'precio_compra_bruto.min' => 'El precio de compra bruto debe ser mayor a 0.',
            'precio_venta.required' => 'El precio de venta público es obligatorio.',
            'precio_venta.numeric' => 'El precio de venta público debe ser un número.',
            'precio_venta.min' => 'El precio de venta público debe ser mayor a 0.',
